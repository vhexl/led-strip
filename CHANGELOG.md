...
## [0.3.0](https://github.com/vhexl/led-strip/compare/v0.2.0...v0.3.0) - 2026-08-13

### Other

- [**breaking**] simplify WireCodec error model, drop BitOrder/PixelKind, validate reset overflow
